...
bckIndx = [0.91, 1.11, 1.16]
bckNrm = [-4.99, -5.09, -5.05]
...
for i in range(int(nspec/2./2.)):
    ...
    ax[1].errorbar(spcx[2*i+int(nspec/2./2.)],spcy[2*i+int(nspec/2./2.)],xerr=spcrrx[2*i+int(nspec/2./2.)],yerr=spcrry[2*i+int(nspec/2./2.)],color=setcolours[i+int(nspec/2./2.)],fmt=' ',capsize=0)
    ax[1].step(np.append(spcx[2*i+int(nspec/2./2.)][0]-spcrrx[2*i+int(nspec/2./2.)][0],spcx[2*i+int(nspec/2./2.)]+spcrrx[2*i+int(nspec/2./2.)]),np.append(mod[2*i+int(nspec/2./2.)][0],mod[2*i+int(nspec/2./2.)]),color=setcolours[i+int(nspec/2./2.)])
    ax[2].errorbar(spcx[2*i+1],scl[i]*spcy[2*i+1],xerr=spcrrx[2*i+1],yerr=scl[i]*spcrry[2*i+1],color=setcolours[i],fmt=' ',capsize=0)
    ax[2].errorbar(spcx[2*i+1+int(nspec/2./2.)],scl[i+int(nspec/2./2.)]*spcy[2*i+1+int(nspec/2./2.)],xerr=spcrrx[2*i+1+int(nspec/2./2.)],yerr=scl[i+int(nspec/2./2.)]*spcrry[2*i+1+int(nspec/2./2.)],color=setcolours[i+int(nspec/2./2.)],fmt=' ',capsize=0)
    ...
    ax[2].step(np.append(spcx[2*i+1+int(nspec/2./2.)][0]-spcrrx[2*i+1+int(nspec/2./2.)][0],spcx[2*i+1+int(nspec/2./2.)]+spcrrx[2*i+1+int(nspec/2./2.)]),np.append(scl[i+int(nspec/2./2.)]*mod[2*i+1+int(nspec/2./2.)][0],scl[i+int(nspec/2./2.)]*mod[2*i+1+int(nspec/2./2.)]),color=setcolours[i+int(nspec/2./2.)])
    ...
    ax[3].errorbar(spcx[2*i+1+int(nspec/2./2.)],scl[i+int(nspec/2./2.)]*chiy[2*i+1+int(nspec/2./2.)],xerr=spcrrx[2*i+1+int(nspec/2./2.)],yerr=scl[i+int(nspec/2./2.)]*chirry[2*i+1+int(nspec/2./2.)],color=setcolours[i+int(nspec/2./2.)],fmt=' ',capsize=0)
