...
def FoldInput(infile):
    ...
    for line in lines:
        ...
        pp[1,13] = 10**pp[1,13]/1.e3
        pp[0,13] = 10**pp[0,13]/1.e3
        pp[2,13] = 10**pp[2,13]/1.e3
        pp[1,12] = pp[1,12]*1.e1
        pp[0,12] = pp[0,12]*1.e1
        pp[2,12] = pp[2,12]*1.e1
...
models = ['bbody','1260','123100','123190','130100']
