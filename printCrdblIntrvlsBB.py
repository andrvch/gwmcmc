...
samples[0] = samples[0] + log10(kev) - log10(kb)
samples[1] = 0.5 * samples[1] + samples[7] + log10(1.e5)
samples[3] = samples[3]
samples[5] = samples[5]
...
#samples2[1] = log10(4.*PIPI*5.6704e-5) + 2.*samples[1] + 4.*samples[0] - 2.*samples[7]
